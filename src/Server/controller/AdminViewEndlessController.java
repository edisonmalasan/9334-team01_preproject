...
import Server.view.AdminViewEndless;
import org.w3c.dom.*;
import java.io.*;


public class AdminViewEndlessController {
    private AdminViewEndless view;

    public AdminViewEndlessController(AdminViewEndless view) {
        this.view = view;
